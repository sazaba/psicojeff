...
export default function AdminLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex font-sans selection:bg-teal-500/30">
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-50 w-[280px] bg-stone-950 text-white transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col border-r border-stone-800/60 shadow-2xl md:shadow-none ${
      ...
      >
        <div className="p-8 flex items-center justify-between">
          ...
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="md:hidden p-2 rounded-lg bg-stone-900 text-white hover:text-white transition-colors"
