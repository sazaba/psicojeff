...
export default function BlogCarouselClient({ posts }: { posts: BlogCarouselPost[] }) {
  ...
  return (
    <section className="py-24 bg-stone-50 relative w-full" style={{ contentVisibility: "auto" }}>
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-stone-300 to-transparent opacity-50" />
      ...
      <div className="container mx-auto px-6">
            ...
            {posts.map((post) => {
              ...
              return (
                <SwiperSlide key={post.id} className="h-auto">
                  <article
                    className={`group h-full flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border relative top-0 hover:-top-2 ${
        ...
        <div className="mt-8 text-center">
          <Link
            href="/blog"
            className="inline-block px-8 py-3 border border-stone-300 rounded-full text-stone-600 font-semibold hover:bg-stone-800 hover:text-white transition-colors"
          >
